...
<form class="layui-form" action="" method="post">
    <div class="container">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" name="title"  lay-verify="required" placeholder="请输入验证码" autocomplete="off" class="layui-input verity">
            </div>
            <!-- <div class="layui-form-mid layui-word-aux">辅助文字</div> -->
        ...
        <a href="" class="font-set">忘记密码?</a>  <a href="../pages/registration.jsp" class="font-set">立即注册</a>
    </div>
</form>
...
<script type="text/javascript">
    layui.use(['form','layer'], function(){
        ...
        form.on('submit(formDemo)', function(data) {
            $.ajax({
                url:"/loginServlet?methodName=login",
                type:'post',
                dataType:'text',
                data:{
                    account:$('#name').val(),
                ...
                success:function(data){
                    if (data == "success") {
                        layer.msg('登陆成功');
                        // alert(1);
                        location.href = "../pages/UserList.jsp";
                    }else {
                        layer.msg('登陆失败');
                    }
                }
