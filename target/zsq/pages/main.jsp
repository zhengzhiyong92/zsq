...
<!--&lt;!&ndash;    <a id="exit" style="float: right;margin-top: 10px;margin-right: 20px;position: absolute;right: 0;top: 10px" onclick="exit()">退出</a>&ndash;&gt;-->
...
<!--</div>-->
<!--<div id="section">-->
<!--    <iframe width="100%" height="100%" src="" id="ifr" name="ifr"></iframe>-->
<!--</div>-->
</body>
